...
@section('title', 'SPKT - Kepolisian Mauk')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('spkt.index') }}">
                    <h4 class="semi-bold mb-0 text-white">SPKT</h4>
                    <p class="italic mt-0 text-white">Sentra Pelayanan Kepolisian Terpadu</p>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('spkt.laporan') }}">Laporan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('spkt.logout') }}"
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('spkt.formRegister') }}" class="btn btn-outline-purple">Daftar</a>
                        </li>
                    </ul>
                    @endauth
                </div>
...
<div class="container">
    <div class="row justify-content-between">
        <div class="col-lg-8 col-md-12 col-sm-12 col-12 col">
            <div class="content content-top shadow">
                ...
                @endif
                <div class="card mb-3">Tulis Laporan Di sini</div>
                <form action="{{ route('spkt.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="row mt-5">
        <div class="col-lg-8">
            <a class="d-inline tab {{ $siapa != 'me' ? 'tab-active' : ''}} mr-4" href="{{ route('spkt.laporan') }}">
                Semua
            </a>
            <a class="d-inline tab {{ $siapa == 'me' ? 'tab-active' : ''}}" href="{{ route('spkt.laporan', 'me') }}">
                Laporan Saya
            </a>
            <hr>
        </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2021 Skripsi • All rights reserved</p>
    </div>
</div>
@endsection
